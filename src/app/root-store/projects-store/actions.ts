...
export enum ActionTypes {
    ...
    LOAD_TASKS_BY_PROJECT_REQUEST = "[Project] Load Tasks By Project Request",
    LOAD_TASKS_BY_PROJECT_SUCCESS = "[Project] Load Tasks By Project Success",
...
export const loadTasksByProjectRequest = createAction(ActionTypes.LOAD_TASKS_BY_PROJECT_REQUEST, props<  { projectId: string } >());
export const loadTasksByProjectSuccess = createAction(ActionTypes.LOAD_TASKS_BY_PROJECT_SUCCESS, props<  { tasks: Array<Task> } >());
